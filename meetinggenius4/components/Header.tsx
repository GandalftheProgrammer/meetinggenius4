        ...
        <div className="flex items-center gap-2 md:gap-4 overflow-x-auto max-w-full pb-1 md:pb-0">
            ...
            <div className="flex items-center gap-2">
                ...
                {user ? (
                   <button 
                    onClick={onLogout}
                    className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 text-slate-600 hover:bg-slate-200 transition-all border border-slate-200 text-xs md:text-sm font-bold shadow-none"
                   >
                  ...
                  <button 
                    onClick={onLogin}
                    disabled={isLocked}
                    className="flex items-center gap-2 px-4 py-1.5 bg-blue-600 text-white rounded-full text-xs md:text-sm font-bold hover:bg-blue-700 transition-all disabled:bg-slate-400 disabled:cursor-not-allowed min-w-[100px] justify-center shadow-none"
                  >
